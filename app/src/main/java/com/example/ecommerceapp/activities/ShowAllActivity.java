...
public class ShowAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (type != null && type.equalsIgnoreCase("cpu")){
            firestore.collection("ShowAll").whereEqualTo("type", "cpu")
                    .get()
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
        ...
        if (type != null && type.equalsIgnoreCase("ram")){
            firestore.collection("ShowAll").whereEqualTo("type", "ram")
                    .get()
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
        ...
        if (type != null && type.equalsIgnoreCase("card")){
            firestore.collection("ShowAll").whereEqualTo("type", "card")
                    .get()
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
            ...
            firestore.collection("ShowAll").whereEqualTo("type", "ssd")
                    .get()
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
            ...
            firestore.collection("ShowAll").whereEqualTo("type", "psu")
                    .get()
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
